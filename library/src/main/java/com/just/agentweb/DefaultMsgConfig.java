...
public final class DefaultMsgConfig {
    ...
    public static final class ChromeClientMsgCfg {
        ...
        public static final class FileUploadMsgConfig implements Parcelable {
            ...
            private Map<String, String[]> medias = new HashMap<>();
            ...
            FileUploadMsgConfig() {
                medias.put(IMAGE_TYPE, new String[]{"相机", "文件选择器"});
            }
            ...
            public void setMedias(Map<String, String[]> medias) {
                this.medias = medias;
            }
            ...
            public String[] getMedias(String type) {
                Iterator<String> iterator = medias.keySet().iterator();
