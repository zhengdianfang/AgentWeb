...
import static com.just.agentweb.DefaultMsgConfig.IMAGE_TYPE;
import static com.just.agentweb.DefaultMsgConfig.VIDEO_TYPE;
...
//        LogUtils.i(TAG, "getUriFromFileForN:" + (context.getPackageName() + ".AgentWebFileProvider"+"   uri:"+fileUri));
    ...
    static Intent getIntentVideoRecordCompat(Context context, File file) {
...
//        Log.i("Info","json:"+mJSONArray);
    ...
    static boolean isImageMedia(String acceptyType) {
       return acceptyType.toLowerCase().contains(IMAGE_TYPE);
    }

    static boolean isVideoMedia(String acceptyType) {
        return acceptyType.toLowerCase().contains(VIDEO_TYPE);
    }
}
